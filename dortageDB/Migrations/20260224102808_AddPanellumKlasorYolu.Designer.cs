...
namespace dortageDB.Migrations
{
    ...
    [Migration("20260224102808_AddPanellumKlasorYolu")]
    partial class AddPanellumKlasorYolu
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dortageDB.Entities.Basvuru", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GayrimenkulTecrubesi")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("KendiniziTanitin")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NeredenDuydunuz")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("SosyalMedyaLink")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("dortageDB.Entities.EgitimVideo", b =>
                {
                    ...
                    b.HasIndex("Aktif", "Sira");

                    b.ToTable("EgitimVideolar");
                });
            ...
            modelBuilder.Entity("dortageDB.Entities.Musteri", b =>
                {
                    ...
                    b.HasIndex("VekarerID");

                    b.ToTable("Musteriler");
                });

            modelBuilder.Entity("dortageDB.Entities.Proje", b =>
                {
                    ...
                    b.Property<string>("GaleriGorselleri")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GaleriGorselleriAlt")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("Imarlimi")
                        .HasColumnType("bit");

                    b.Property<string>("KapakGorseli")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KapakGorseliAlt")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KapakVideosu")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("dortageDB.Entities.Satis", b =>
                {
                    ...
                    b.HasIndex("VekarerID", "SatilmaTarihi");

                    b.ToTable("Satislar");
                });

            modelBuilder.Entity("dortageDB.Entities.SeoSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dortageDB.Entities.VekarerProfile", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("dortageDB.Entities.Musteri", b =>
                {
                    b.HasOne("dortageDB.Entities.AppUser", "Vekarer")
                        .WithMany("Musteriler")
                        .HasForeignKey("VekarerID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Vekarer");
                });
            ...
            modelBuilder.Entity("dortageDB.Entities.Randevu", b =>
                {
                    ...
                    b.HasOne("dortageDB.Entities.Proje", "Proje")
                        .WithMany("Randevular")
            ...
            modelBuilder.Entity("dortageDB.Entities.VekarerProfile", b =>
                {
                    b.HasOne("dortageDB.Entities.AppUser", "User")
                        .WithOne("VekarerProfile")
                        .HasForeignKey("dortageDB.Entities.VekarerProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
